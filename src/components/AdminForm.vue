...
<template>
  <div style="background: #fff; width: 420px">
    ...
    <q-tab-panels v-model="panel" animated class="rounded-borders">
      ...
      <q-tab-panel name="zhyaf" class="q-gutter-y-md">
        <q-select
          v-model="admin.device_api_version"
          label="Usuario Zhyaf"
          stack-label
          outlined
          :options="[
            { name: 'IETECNO', id: 'v1' },
            { name: 'PHENLINEA', id: 'v2' },
          ]"
          :option-label="'name'"
          emit-value
          option-value="id"
      ...
      <q-tab-panel name="credentials" class="q-gutter-y-md">
        <q-input
          v-model="admin.email"
          label="Email"
          outlined
        ...
        >
          <template v-slot:append="">
            <q-btn flat round icon="remove_red_eye"></q-btn>
          </template>
        </q-input>
      </q-tab-panel>
    </q-tab-panels>
