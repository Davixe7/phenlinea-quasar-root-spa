...
const columns = ref([
  { name: "id", label: "ID", field: "id", align: "left", sortable: "true" },
  {
    name: "adminName",
    label: "Admin",
    field: (row) => (row.admin ? row.admin.name : "NINGUNO"),
    align: "left",
    sortable: "true",
  },
  {
...
<template>
  ...
  >
    ...
    <template v-slot:body-cell-adminName="props">
      <q-td class="text-limited">
        {{ props.row.admin ? props.row.admin.name : "NINGUNO" }}
      </q-td>
    </template>
  ...
  <q-dialog v-model="dialog">
    <PorteriaForm :porteria="porteria" @saved="dialog = false"></PorteriaForm>
  </q-dialog>
