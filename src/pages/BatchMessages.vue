...
const columns = ref([
    ...
    { name: 'admin_id', field: row => row.admin.name, label: 'Administrador', sortable: false, align: 'left' },
    { name: 'title', field: 'title', label: 'Asunto', sortable: false, align: 'left' },
    { name: 'created_at', field: 'created_at', label: 'Fecha', sortable: true, align: 'left' },
    { name: 'status', field: 'status', label: 'Estado', sortable: true, align: 'left' },
